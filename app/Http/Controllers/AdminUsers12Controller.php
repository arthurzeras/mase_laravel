<?php namespace App\Http\Controllers;
	...
	class AdminUsers12Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Matrícula','name'=>'matricula','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Matricula","name"=>"matricula","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
